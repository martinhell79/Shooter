...
def start_game(time_limit=30):
    ...
    while running:
        if (game_setup.CurrentState == GAME_STATE['Start_Screen']):
            ...
            running, score = events.consume_events(score, objects, planes, bonus_circle, score_popups, explosions, laser_shots, current_time)
            
            render.render_objects(objects + planes + bonus_circle, current_time=current_time, dt=dt)
